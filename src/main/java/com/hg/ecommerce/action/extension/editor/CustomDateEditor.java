 ...
 * 
 * <p>此类是从Spring Framework中摘出来供大家学习如何去自定义PropertyEditor的，PropertyEditor有两个
 * 核心方法真正起到类型转换作用，那就是setAsText和getAsText，覆盖这两个方法来达到类型转换目的，而为你匹配合适的
 * PropertyEditor来进行类型转换，是Spring的工作</p>
 * 
